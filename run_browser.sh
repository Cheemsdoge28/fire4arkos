...
export FIRE4ARKOS_USER_AGENT="${FIRE4ARKOS_USER_AGENT:-Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36}"
export FIRE4ARKOS_NO_SLEEP="${FIRE4ARKOS_NO_SLEEP:-0}"
export FIRE4ARKOS_FRAME_SKIP="${FIRE4ARKOS_FRAME_SKIP:-2}"
export FPS="${FPS:-30}"
